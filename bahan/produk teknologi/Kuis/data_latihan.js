...
//=============menambahkan class
            ...
            if(nilai==1){
                let soal2 = document.createElement('div');
                soal2.setAttribute('id', 'soal2');

                inti_pertanyaan.appendChild(soal2);
            }
            if(nilai==4){
                let soal5 = document.createElement('div');
                soal5.setAttribute('id', 'soal5');

                inti_pertanyaan.appendChild(soal5);
            }
            if(nilai==8){
                let soal9 = document.createElement('div');
                soal9.setAttribute('id', 'soal9');

                inti_pertanyaan.appendChild(soal9);
            }
...
// memasukan gambar kesoal=============================//
        var gambar= new Image(400);
        gambar.src='gambar/soal2.png';
         x=document.getElementById("soal2");
        x.appendChild(gambar);

        var gambar5= new Image(400);
        gambar5.src='gambar/soal5.png';
         y=document.getElementById("soal5");
        y.appendChild(gambar5);

        var gambar9= new Image(400);
        gambar9.src='gambar/soal9.png';
         y=document.getElementById("soal9");
        y.appendChild(gambar9);
