...
//=============menambahkan class
            ...
            if(nilai==9){
                ...
                soal10.setAttribute('id', 'soal10');

                inti_pertanyaan.appendChild(soal10);
            }
            if(nilai==10){
                let soal11 = document.createElement('div');
                soal11.setAttribute('id', 'soal11');

                inti_pertanyaan.appendChild(soal11);
            }
...
// memasukan gambar kesoal=============================//
        ...
        gambart.src='gambar/11.png';
         y=document.getElementById("soal11");
